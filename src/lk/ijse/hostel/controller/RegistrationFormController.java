...
public class RegistrationFormController implements Initializable {
    ...
    void btnAdd(ActionEvent event) {
        ...
        boolean isAdded = reservationBO.saveRegistration(new ReservationDTO(res_id, student_id,room_id,date, status));
        Alert alert;
        if (isAdded) {
            table.getItems().add(new ReservationTM(res_id,student_id, room_id,date, status));
    ...
    void btnDelete(ActionEvent event) {
        ...
        lblDate.setText(null);
        boolean isAdded = reservationBO.saveRegistration(new ReservationDTO(res_id, student_id,room_id,date, status));
        boolean isDeleted = reservationBO.deleteRegistration(new ReservationDTO(res_id, student_id,room_id,date, status));
        Alert alert;
        if (isDeleted) {
    ...
    void btnUpdate(ActionEvent event) {
        ...
        boolean isAdded = reservationBO.saveRegistration(new ReservationDTO(res_id, student_id,room_id,date, status));
        boolean isDeleted = reservationBO.deleteRegistration(new ReservationDTO(res_id, student_id,room_id,date, status));
        boolean isUpdated = reservationBO.updateRegistration(new ReservationDTO(res_id, student_id,room_id,date, status));
        Alert alert;
        if (isUpdated) {
